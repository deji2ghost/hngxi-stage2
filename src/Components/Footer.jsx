...
export const Footer = () => {
  return (
    <div className='py-3 px-8'>
        <div className='flex items-center justify-between text-brown font-[400]'>
            {
                footer.map(foot=> {
                    return(
                        <div key={foot.id} className='flex items-center gap-4'>
                            ...
                            <div>
                                ...
                                <p className='text-[12px]'>{foot.paragraph}</p>
                            </div>
                        </div>
                    )
                })
        ...
        <div className='flex items-center justify-between'>
            <div className='w-[50%] border'>
                <div>
                    ...
                    <ul>
                        <li className='text-[12px]'>Chat with us</li>
                        <li className='text-[12px]'>Help Center</li>
                ...
                <div>
                    ...
                    <div className='flex items-center'>
                        <div className='w-[5%] border'><img src={Facebook} /></div>
                        <div className='w-[5%] border'><img src={TwitterX} /></div>
                        <div className='w-[5%] border'><img src={Instagram} /></div>
                    </div>
                </div>
            </div>
            <div className='w-[27%] border'>
